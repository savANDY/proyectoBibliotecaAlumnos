...
public class FormularioDeModificado extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public FormularioDeModificado(GestionSocio parent, boolean modal) {
		super(parent, modal);
	...
	protected void modificacion() {
		...
		this.controladorSocio.modificarSocio(Integer.parseInt(this.id.getText()), this.nombre.getText(),
				this.apellido.getText(), this.direccion.getText(), this.poblacion.getText(), this.provincia.getText(),
				this.dni.getText());
