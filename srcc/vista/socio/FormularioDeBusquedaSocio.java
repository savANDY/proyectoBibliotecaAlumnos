...
public class FormularioDeBusquedaSocio extends JDialog {
										...
										.addGroup(gl_contentPanel
												.createParallelGroup(Alignment.LEADING, false).addGroup(gl_contentPanel
														...
														.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
																...
																.addComponent(lblProvincia, GroupLayout.PREFERRED_SIZE,
														...
														.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
																...
																.addComponent(apellido, GroupLayout.PREFERRED_SIZE,
																		GroupLayout.DEFAULT_SIZE,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(comboPoblacion,
																		GroupLayout.PREFERRED_SIZE, 86,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(comboProvincias,
																		GroupLayout.PREFERRED_SIZE, 86,
																		GroupLayout.PREFERRED_SIZE))
														.addGap(10)
														.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
																.addComponent(buscarNombre, GroupLayout.PREFERRED_SIZE,
																		88, GroupLayout.PREFERRED_SIZE)
																.addComponent(
																		buscarApellido, GroupLayout.PREFERRED_SIZE, 88,
																		GroupLayout.PREFERRED_SIZE)
												...
												.addGroup(gl_contentPanel.createSequentialGroup().addContainerGap()
														.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 550,
																GroupLayout.PREFERRED_SIZE)))
										.addContainerGap()));
		gl_contentPanel.setVerticalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPanel
				.createSequentialGroup().addGap(11).addComponent(lblSelccionaElAlumno).addGap(6)
				.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(4).addComponent(lblNombre))
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(1).addComponent(nombre,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(buscarNombre))
				.addGap(6)
				.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(4).addComponent(lblApellido))
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(1).addComponent(apellido,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(buscarApellido))
				.addGap(11)
				.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addComponent(lblPoblacion)
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(1).addComponent(comboPoblacion,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(buscarPoblacion))
				.addGap(18)
				.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(4).addComponent(lblProvincia))
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(1).addComponent(comboProvincias,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(buscarProvincia))
				.addGap(7).addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE).addGap(12)));
	...
	public void rellenarTabla(ArrayList<Socio> socios) {
		...
		for (Socio socio : socios) {
			Object[] lerroa = { socio.getNombre(), socio.getApellido(), socio.getDireccion(), socio.getPoblacion(),
