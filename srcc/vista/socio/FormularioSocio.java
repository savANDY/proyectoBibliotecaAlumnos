		...
		gl_contentPanel.setHorizontalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup().addContainerGap()
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING).addComponent(lblNombre)
								.addComponent(lblApellido).addComponent(lblDireccion).addComponent(lblPoblacion)
						...
						.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPanel.createSequentialGroup()
										.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
												.addComponent(textNombre, GroupLayout.PREFERRED_SIZE,
				...
				.addGroup(gl_contentPanel.createSequentialGroup().addGap(10).addComponent(btnGuardar).addGap(39)
						.addComponent(btnCancelar).addContainerGap(229, Short.MAX_VALUE)));
